## 任务描述
读取 ./reviewed_clips_2026-04-24.csv 分析并按照如下处理：
...
###  输出文件
1. train set 结果存放文件：waylens-train-collision-v4/meta.csv
2. train set video 存放目录：waylens-train-collision-v4/videos/
3. train set 说明文件：waylens-train-collision-v4/README.md
