# Waylens Train Collision Dataset v4
...
- Total samples: 2395
- Collision Detected (Positive): 84
- Non-Collision Detected (Negative): 2311
- Excluded rows: 15 (`Indeterminate Collision Detection`)
...
| L2 | Count |
|----|-------|
| Collision - Accident | 61 |
| Collision - Non-Accident | 23 |
...
| Dirty Data | 273 |
| Near Miss | 176 |
| Rough Road Segment | 159 |
| Severe Lighting Variation | 11 |
